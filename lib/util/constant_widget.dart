  ...
  return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(18.h),
              borderSide: BorderSide(color: bordrColor, width: 0)),
          ...
          suffixIcon: Container(
                  decoration: BoxDecoration(
                      border: Border(left: BorderSide(color: bordrColor))),
                  child: getSvgImage("filter_icon.svg").paddingOnly(left: 16.h,right: 12.h))
...
Widget getHomeAppBar(String image, String title,
    {Widget? widget,
    Function? function,
    ...
    children: [
      Row(
        children: [
          ...
          getHorSpace(15.13.w),
          getCustomFont(title, titlefontsize ?? 18.sp, Colors.black, 1,
...
Widget getDetailFacelity(String iconImage, String text,
  ...
  return Container(
    ...
    child: Row(
      ...
      children: [
        ...
        Row(
          children: [
            getCustomFont(text, 14.sp, regularBlack, 1,
                fontWeight: FontWeight.w400),
            superScript
                ? getCustomFont("2", 14.sp, regularBlack, 1,
                    fontWeight: FontWeight.w400,
